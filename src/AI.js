export default function results0(info) {
    ...
    question1 = info["Question4"]; //think about/question sexuality
    question2 = info["Question5"]; //confidence about sexuality
    question3 = info["Question6"]; //open about sexuality
    question4 = info["Question7"]; //assumptions
    question5 = info["Question8"]; //consider lgbtq
    question6 = info["Question9"]; //comfortable with lgbtq
    question7 = info["Question10"]; //educated
    question8 = info["Question11"]; //quizzes
    question9 = info["Question12"]; //response
...
export function results1(info) {
    let tally = {"closeted": 0, "questioning": 0, "comfortable": 0}
    return (
        <div className="result">
            <h3>You are undecided!</h3>
            <p>This is a placeholder

                <br />

                Come back later for actual results :).
            </p>
        </div>
    );
}